                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CompareValidator ID="CompareValidator2" runat="server" 
                                                    ControlToValidate="DropDownListHrs" ErrorMessage="Hrs?" ForeColor="#FF3300" 
                                                    Operator="NotEqual" ToolTip="Hrs?" ValidationGroup="attributes" 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CompareValidator ID="CompareValidator19" runat="server" 
                                                    ControlToValidate="DropDownListPUC" ErrorMessage="PUC?" 
                                                    ForeColor="#FF3300" Operator="NotEqual" ToolTip="PUC?" 
                                                    ValidationGroup="attributes" ValueToCompare="Select"></asp:CompareValidator>
                                            </td>
                                        </tr>
                                        <tr>
									    ...
									    <tr>
                                            ...
                                            <td align="left" class="style4">
                                                <asp:Button ID="btnCheck" runat="server" onclick="btnCheck_Click" 
                                                    Text="Result Prediction" Width="150px" Height="50px" 
                                                    ValidationGroup="attributes" /> &nbsp&nbsp
                                                </td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
